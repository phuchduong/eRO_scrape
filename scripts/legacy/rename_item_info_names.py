...
'''
    ...
    Version: 1.0.0
    Purpose:
        Rename the item names from an item_info
...
def main():
    ...
    # Input data files
    item_info_in_dir = repo_dir + "/eRODev/eRO Client Data/System/itemInfosryx.lub"
    ...
    # Output files
    db_path_out = out_folder_path + "itemInfosryx.lub"
    rename_and_write_item_info(
        rename_list=rename_list,
        db_path_in=item_info_in_dir,
    ...
    sp.Popen([program_dir, item_info_in_dir])
