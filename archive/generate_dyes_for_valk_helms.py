...
first_valk_helm_id = 49000
last_valk_helm_id = 49175
types_of_valk_helms = 8
for beg_type_id in range(first_valk_helm_id, last_valk_helm_id + 1, types_of_valk_helms):
    valk_helm_ids = range(beg_type_id, beg_type_id + 8)
