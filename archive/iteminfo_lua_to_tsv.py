...
def main():
    ...
    ########################################################################################
    # 1a. <item_info.lua> List out all sprite names and item id combinations from the lua. #
    ########################################################################################

    ########################################################################################
    # 2a. List all spritesnames from the grf                                               #
    # 2b. Filter out sprites that do not have 4 assets.                                    #
    ########################################################################################

    ########################################################################################
    # 3. Filter out items from the lua that do have an existing sprite in the grf,         #
    #    since they are probably for other servers                                         #
    ########################################################################################

    ########################################################################
    # 4. Build a table that links reborn item_ids with their sprites names #
    ########################################################################
